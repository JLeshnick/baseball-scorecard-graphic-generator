...
const GUIDE_SECTIONS = [
  {
    ...
    items: [
      ...
      { code: 'HR', name: 'Home Run', desc: 'Full diamond highlight & 4 bases reached', badgeColor: '#8b5cf6' },
      ...
      { code: 'HBP', name: 'Hit by Pitch', desc: 'Awarded 1st base after being struck', badgeColor: '#10b981' },
      { code: 'CI', name: "Catcher's Interference", desc: 'Awarded 1st base on interference', badgeColor: '#10b981' },
    ],
  },
  {
    category: 'Strikeouts',
  ...
  {
    category: 'Field Outs & Defensive Plays',
    items: [
      ...
      { code: '5-4-3 TP', name: 'Triple Play', desc: '3B to 2B to 1B (3 outs recorded)', badgeColor: '#ef4444' },
  ...
  {
    category: 'Basepath Outs, Fates & Lineups',
    items: [
      ...
      { code: 'SCORED', name: 'Scored Run', desc: 'Batter crossed home plate to score a run', badgeColor: '#10b981' },
      { code: 'LOB', name: 'Left on Base', desc: 'Runner left stranded on base at 3rd out', badgeColor: '#f59e0b' },
      { code: 'FATE', name: 'Inning Fate', desc: 'Final outcome of the runner by end of inning', badgeColor: '#3b82f6' },
      { code: '① / ②', name: 'Multiple At-Bats in Inning', desc: 'Team batted around in order (1st vs 2nd PA)', badgeColor: '#3b82f6' },
      { code: 'a. / b.', name: 'Lineup Substitution', desc: 'Pinch hitter or defensive replacement', badgeColor: '#38bdf8' },
    ],
  },
  {
    category: 'Pitch Types & Visualizer Nomenclature',
    items: [
      { code: '4-Seam', name: 'Four-Seam Fastball', desc: 'High-velocity riding fastball (FF)', badgeColor: '#ef4444' },
      { code: '2-Seam', name: 'Two-Seam Fastball', desc: 'Fastball with arm-side tailing run (FT)', badgeColor: '#ef4444' },
      { code: 'Cutter', name: 'Cut Fastball', desc: 'Fastball with sharp glove-side cut (FC)', badgeColor: '#f97316' },
      { code: 'Sinker', name: 'Sinker', desc: 'Heavy downward running fastball (SI)', badgeColor: '#f97316' },
      { code: 'Slider', name: 'Slider', desc: 'Sharp horizontal/downward breaking pitch (SL)', badgeColor: '#f59e0b' },
      { code: 'Sweeper', name: 'Sweeper', desc: 'High-spin wide horizontal sweep slider (ST)', badgeColor: '#f59e0b' },
      { code: 'Slurve', name: 'Slurve', desc: 'Hybrid slider-curveball break (SV)', badgeColor: '#f59e0b' },
      { code: 'Changeup', name: 'Changeup', desc: 'Off-speed pitch with late drop (CH)', badgeColor: '#10b981' },
      { code: 'Curveball', name: 'Curveball', desc: '12-6 or sweeping vertical loop (CU)', badgeColor: '#06b6d4' },
      { code: 'Knuckle Curve', name: 'Knuckle Curve', desc: 'Spiked-grip sharp downer curveball (KC)', badgeColor: '#06b6d4' },
      { code: 'Splitter', name: 'Splitter', desc: 'Tumbling split-finger dive (FS)', badgeColor: '#8b5cf6' },
      { code: 'Forkball', name: 'Forkball', desc: 'Deep-grip plunging pitch (FO)', badgeColor: '#8b5cf6' },
      { code: 'Knuckleball', name: 'Knuckleball', desc: 'Erratic zero-spin flutterball (KN)', badgeColor: '#a855f7' },
      { code: 'Eephus', name: 'Eephus', desc: 'Ultra slow high-arcing rainbow pitch (EP)', badgeColor: '#a855f7' },
      { code: 'Int. Ball', name: 'Intentional Ball', desc: 'Intentional ball thrown outside (IN)', badgeColor: '#10b981' },
      { code: 'Front / Side', name: 'Pitch Angle Perspectives', desc: "Catcher's front zone vs Mound-to-Plate flight arc", badgeColor: '#3b82f6' },
      { code: 'Drop Break', name: 'Vertical Break', desc: 'Total vertical drop from release to plate in inches', badgeColor: '#3b82f6' },
    ],
  },
  {
    category: 'Hit Spray & Statcast Nomenclature',
    items: [
      { code: 'Exit Velo', name: 'Exit Velocity (MPH)', desc: 'Speed of batted ball off the bat', badgeColor: '#3b82f6' },
      { code: 'Launch Ang', name: 'Launch Angle (°)', desc: 'Vertical departure angle off the bat', badgeColor: '#f59e0b' },
      { code: 'Distance', name: 'Projected Distance (FT)', desc: 'Projected landing distance in feet', badgeColor: '#10b981' },
      { code: 'Ground Ball', name: 'Grounder (< 10°)', desc: 'Batted ball driven across the infield turf', badgeColor: '#64748b' },
      { code: 'Line Drive', name: 'Line Drive (10°–25°)', desc: 'Hard-hit line trajectory with high hit probability', badgeColor: '#10b981' },
      { code: 'Fly Ball', name: 'Fly Ball (25°–50°)', desc: 'Elevated ball into the outfield / home run zone', badgeColor: '#8b5cf6' },
      { code: 'Pop Up', name: 'Pop Up (> 50°)', desc: 'High steep ball caught in the infield/foul territory', badgeColor: '#f59e0b' },
      { code: 'Foul Ball', name: 'Foul Ball (Dashed Arc)', desc: 'Trajectory outside foul lines (amber dashed line)', badgeColor: '#f59e0b' },
      { code: 'Elevation Arc', name: 'Side Flight Apex', desc: 'Elevation profile showing trajectory apex vs 10 FT wall', badgeColor: '#3b82f6' },
    ],
  },
  {
